...
двух объектов, а ">=" и "<=" - п1ерегруженные операции сравнения
...
| Команда | Описание |
|---|---|
| `make lab2` | Компиляция лабораторной работы 2 |
| `make lab2-run` | Компиляция и запуск |
| `make lab2-format` | Форматирование кода через `clang-format` |
