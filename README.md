...
| Команда | Описание |
|---|---|
| `make` | Компиляция лабораторной работы 2 |
| `make oop-run` | Компиляция и запуск |
| `make oop-format` | Форматирование кода через `clang-format` |
| `make clean` | Удаление всех скомпилированных файлов |